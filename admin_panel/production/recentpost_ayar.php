...
if (isset($_POST['arama'])) {
  $aranan=$_POST['aranan'];
  $recentpostsor=$db->prepare("SELECT * FROM recentpost WHERE recent_baslik LIKE '%$aranan%'  ORDER BY recentpost_id DESC");
  $recentpostsor->execute();
  $say=$recentpostsor->rowCount();
          ...
          <div class="">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <form action="" method="post">
                    <div class="input-group">
                      <input type="text" class="form-control" name="aranan" placeholder="Anahtar Kelime Gir...">
            ...
            <div class="x_content">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    <div class="x_title">
                        <h2>Öne Çıkan Başlık Ayarları   &nbsp  &nbsp
